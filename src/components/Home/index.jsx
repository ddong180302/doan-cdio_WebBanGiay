...
import { callFetchListProduct, callFetchCategory } from "../../services/api";
...
const Home = () => {
  ...
  const [sortQuery, setSortQuery] = useState("order=updatedAt DESC");
          ...
          <Col md={20} xs={24}>
            <Spin spinning={isLoading} tip="loading...">
              ...
              >
                <Row>
                  <Tabs
                    defaultActiveKey="order=updatedAt DESC"
                    items={items}
